...
void SckUrban::getReading(OneSensor *wichSensor)
{
	...
	switch(wichSensor->type) {
		...
		case SENSOR_CO_HEAT_VOLT: 		wichSensor->reading = String(sck_mics4514.getCOheatVoltage()); return;
		case SENSOR_CO_HEAT_TIME:		wichSensor->reading = String(sck_mics4514.getHeatTime(rtc->getEpoch())); return;
		...
		case SENSOR_NO2_HEAT_VOLT: 		wichSensor->reading = String(sck_mics4514.getNO2heatVoltage()); return;
		case SENSOR_NO2_HEAT_TIME:		wichSensor->reading = String(sck_mics4514.getHeatTime(rtc->getEpoch())); return;
